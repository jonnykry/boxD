...
class TestBoxdRunner(unittest.TestCase):
    ...
    def test_get_remove_player(self):
        ...
        players = GameRunner.get_other_players("0")
        ...
        players = GameRunner.get_other_players("2")
    ...
    def test_creates_and_destroys_games(self):
        ...
        self.assertItemsEqual([str(x) for x in range(0, 33)], GameRunner.get_other_players("0"))
        ...
        self.assertItemsEqual([str(x) for x in range(0, 33)], GameRunner.get_other_players("32"))
